        ...
        <div className="shadow-md flex border-[1px] border-gray-300 w-[600px] rounded-md">
            ...
            <div className='form w-full'>
                ...
                <form action="#" className='p-8 px-3'>
                    ...
                    <input type="text" placeholder='Username' className='w-full block p-2 outline-none border-2 border-gray-300 mt-2 rounded-md focus:border-blue-400'/>
                    <input type="email" placeholder='Email address' className='w-full block p-2 outline-none border-2 border-gray-300 mt-2 rounded-md focus:border-blue-400'/>
                    ...
                    <button type='submit' className='w-full mt-4 bg-blue-500 text-white p-2 rounded-md'>Create account</button>  
